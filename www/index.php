...
else
{
    ...
    <div id="primary">
        <div class="scroller">
                <ul id="fade">
                    <li><img src="files/slider1.jpg" alt="First Scroller Image" /></li>
                    <li><img src="files/slider2.jpg" alt="Second Scroller Image" /></li> 
                    <li><img src="files/slider3.jpg" alt="Third Scroller Image" /></li> 
                </ul>
				<right>
        </div><!--End scroller-->
        <div class="feature-content">
             <h3><a href="index2.php">&#187; Новости сайта.</a><h3>
            <h3>&#187; Новости школы.</h3>
            <h1><a href="#">Региональная контрольная работа</a></h1>
            <p class="subhead">Внимание! Учащиеся 5, 8-11 классов и их родители! Напоминаем, что 17.02.2015 года состоится региональная контрольная работа по литературе.</p>
